...
import { inputWallet, visualWallet } from "../controllers/wallet.controllers.js";
...
walletRouter.post("/wallet",userTokenValidate,schemaValidate(walletSchema), inputWallet)
